/**
 * Tool argument path helpers for the VCC compaction pipeline.
 *
 * Ported from pi-blackhole (src/core/tool-args.ts).
 */

/** Canonical list of path-like argument keys across all tools. */
